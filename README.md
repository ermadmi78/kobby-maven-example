...
This example uses [Kotlinx Serialization](https://github.com/ermadmi78/kobby/issues/7) engine. To see an example with Jackson serialization switch to branch [jackson](https://github.com/ermadmi78/kobby-maven-example/tree/jackson).
...
See example of GraphQL controller authorization [here](https://github.com/ermadmi78/kobby-maven-example/blob/main/kobby-maven-example-cinema-server/src/main/kotlin/io/github/ermadmi78/kobby/cinema/server/controller/QueryController.kt)
